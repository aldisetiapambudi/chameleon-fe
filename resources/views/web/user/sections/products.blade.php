...
@section('section')
    ...
    <div class="container mx-auto">
        <div class="px-6 py-4 grid grid-cols-1 md:grid-cols-3 grid-flow-row auto-rows-max gap-0">
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="" src="https://flowbite.com/docs/images/products/product-1.png"
                        alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
